...
class SessionImage(Base):
    ...
    skin_guard_applied = Column(Boolean, default=False)
    processing_time_ms = Column(Integer, nullable=True)
    face_detected = Column(Integer, default=0)
    face_bbox_json = Column(Text, nullable=True)
    face_zone_json = Column(Text, nullable=True)
    face_zone_version = Column(String(100), nullable=True)
    mesh_confidence = Column(Float, nullable=True)
    face_pose_json = Column(Text, nullable=True)
    skin_stats_json = Column(Text, nullable=True)
    mask_cache_path = Column(String(500), nullable=True)
    debug_artifacts_kept = Column(Integer, default=0)
    created_at = Column(DateTime, default=utcnow)
